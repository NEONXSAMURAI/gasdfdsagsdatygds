...
/*
ÿ‡·ÎÓÌ ÒÓÁ‰‡ÌËˇ ÌÓ‚˚ı ‰‚ÛıÏÂÒÚÌ˚ı Ï‡¯ËÌ Í‡·ËÓÎÂÚÓ‚
/obj/gta13cars/car/sportscar/‚‡¯‡ Ï‡¯ËÌ‡ - œÛÚ¸
	name = "“”“ Õ¿«¬¿Õ»≈ Ã¿ÿ»Õ€"
	desc = "≈≈ Œœ»—¿Õ»≈"
	icon = 'icons/gta13/cars/Õ¿«¬¿Õ»≈ ‘¿…À¿ —Œ —œ–¿…“ŒÃ.dmi'
	icon_state = "4-≈’ Õ¿œ–¿¬Àﬂ≈ÕÕ€… —œ–¿…“ Ã¿ÿ»Õ€(—ÃŒ“–»“≈ œŒ ¿Õ¿ÀŒ√»» — Œ —“¿–€Ã» ‘¿…À¿Ã» —œ–¿…“Œ¬)"
	iscp = 'icons/gta13/cars/Õ¿«¬¿Õ»≈ ‘¿…À¿ —Œ —œ–¿…“ŒÃ.dmi'
	isn = "—œ–¿…“ Õ¿œ–¿¬À≈ÕÕ€… Õ¿ —≈¬≈–"
	iss = "ﬁ√"
	iswp ="«¿œ¿ƒ — œ¿——¿∆»–ŒÃ"
	isw = "«¿œ¿ƒ"
	isep = "¬—Œ—“Œ  — œ¿——¿∆»–ŒÃ"
	ise = "¬Œ—“Œ "
	move_delay = «Õ¿◊≈Õ»≈ - ◊ÂÏ ÏÂÌ¸¯Â, ÚÂÏ ·ÓÎ¸¯Â ÒÍÓÓÒÚ¸
*/
